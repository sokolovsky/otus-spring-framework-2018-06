...
public class StatisticServiceImpl implements StatisticService {
    ...
    private Mono<EntityStatistic> getContextAggregationResult(String field, Class<? extends ResultDbItem> classId) {
    ...
    @Override
    public Mono<EntityStatistic> getGenreToBookStatistic() {
        return getContextAggregationResult("genres", ResultGenre.class);
    }

    @Override
    public Mono<EntityStatistic> getAuthorsToBookStatistic() {

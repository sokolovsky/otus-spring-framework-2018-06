...
class AuthorPersistenceTest {
    ...
    void saveEntity() {
        ...
        author = repository.save(author).block();
    ...
    void findSavedEntity() {
        ...
        repository.save(author).block();
        Author storedEntity = repository.findByName("Some author").block();
    ...
    void findCollection() {
        List<Author> all = repository.findAll().collectList().block();
    ...
    void storedIdIsNotNull() {
        Author author = repository.findAll().blockFirst();
